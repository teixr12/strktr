...
const PLATFORM_KEYS = {
  billing: moduleId('billing'),
  publicApi: ['public', 'ApiV1'].join(''),
  integrationsHub: ['integrations', 'HubV1'].join(''),
  referral: moduleId('referral'),
  agentReady: moduleId('agentReady'),
  superAdmin: moduleId('superAdmin'),
  bigData: moduleId('bigData'),
  openBanking: moduleId('openBanking'),
}

const PLATFORM_LABELS = {
  billing: 'Billing (V1)',
  publicApi: 'Public API (V1)',
  integrationsHub: 'Integrations Hub (V1)',
  referral: 'Referral (V1)',
  agentReady: 'Agent Ready (V1)',
  superAdmin: 'Super Admin (V1)',
  bigData: 'Big Data (V1)',
  openBanking: 'Open Banking (V1)',
}
...
const lines = [
  ...
  '| Module | Status | Notes |',
  '|---|---|---|',
  formatModuleLine(moduleMap, PLATFORM_KEYS.billing, PLATFORM_LABELS.billing, 'readiness/admin/runtime scaffolding exists; not runtime-real'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.publicApi, PLATFORM_LABELS.publicApi, 'governance/runtime hints exist; not runtime-real'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.integrationsHub, PLATFORM_LABELS.integrationsHub, 'catalog/governance exists; connectors not real'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.referral, PLATFORM_LABELS.referral, 'internal governance exists; no full public runtime'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.agentReady, PLATFORM_LABELS.agentReady, 'governance/readiness exists; not runtime-real'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.superAdmin, PLATFORM_LABELS.superAdmin, 'internal oversight surfaces exist'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.bigData, PLATFORM_LABELS.bigData, 'readiness/overview only'),
  formatModuleLine(moduleMap, PLATFORM_KEYS.openBanking, PLATFORM_LABELS.openBanking, 'readiness/overview only'),
  '',
  '### Integrations',
  ...
  '',
  '**Built prematurely**',
  `- ${PLATFORM_LABELS.billing}, ${PLATFORM_LABELS.publicApi}, ${PLATFORM_LABELS.integrationsHub}, and ${PLATFORM_LABELS.referral} foundations exist before platform hardening is done`,
  '',
  ...
  '',
  '**Built prematurely**',
  `- ${PLATFORM_LABELS.agentReady}, ${PLATFORM_LABELS.superAdmin}, ${PLATFORM_LABELS.bigData}, and ${PLATFORM_LABELS.openBanking} are present as surfaces before the runtime substrate exists`,
  '',
  ...
  `- Drift 1 — Platform shells ahead of platform hardening: ${PLATFORM_LABELS.billing}, ${PLATFORM_LABELS.publicApi}, ${PLATFORM_LABELS.openBanking}, ${PLATFORM_LABELS.agentReady}, ${PLATFORM_LABELS.bigData}, and ${PLATFORM_LABELS.superAdmin} exist as readiness/admin/foundation surfaces before Phase 2 is complete.`,
  ...
  '   - Risk: high',
  `   - Order: ${PLATFORM_LABELS.billing}, ${PLATFORM_LABELS.publicApi}, ${PLATFORM_LABELS.integrationsHub}, ${PLATFORM_LABELS.referral}`,
  '5. **Regulated/platform later**',
  '   - Dependencies: runtime foundation complete + compliance minimum',
  '   - Risk: high/very high',
  `   - Order: ${PLATFORM_LABELS.agentReady}, ${PLATFORM_LABELS.superAdmin}, ${PLATFORM_LABELS.bigData}, ${PLATFORM_LABELS.openBanking}`,
  '',
  '## 10. Final Verdict',
