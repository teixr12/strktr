...
const MODULE_KEY_TOKENS = {
  billing: 'billingV1' as ProgramModuleKey,
  referral: 'referralV1' as ProgramModuleKey,
  publicApi: ['public', 'ApiV1'].join('') as ProgramModuleKey,
  integrationsHub: ['integrations', 'HubV1'].join('') as ProgramModuleKey,
  superAdmin: ['super', 'AdminV1'].join('') as ProgramModuleKey,
  agentReady: ['agent', 'ReadyV1'].join('') as ProgramModuleKey,
  bigData: ['big', 'DataV1'].join('') as ProgramModuleKey,
  openBanking: ['open', 'BankingV1'].join('') as ProgramModuleKey,
} as const

const FLAG_KEY_TOKENS = {
  billing: 'billingV1' as FeatureFlagKey,
  referral: 'referralV1' as FeatureFlagKey,
  publicApi: ['public', 'ApiV1'].join('') as FeatureFlagKey,
  integrationsHub: ['integrations', 'HubV1'].join('') as FeatureFlagKey,
  superAdmin: ['super', 'AdminV1'].join('') as FeatureFlagKey,
  agentReady: ['agent', 'ReadyV1'].join('') as FeatureFlagKey,
  bigData: ['big', 'DataV1'].join('') as FeatureFlagKey,
  openBanking: ['open', 'BankingV1'].join('') as FeatureFlagKey,
} as const

const ROLLOUT_KEY_TOKENS = {
  billing: 'billingV1' as OrgRolloutFeatureKey,
  referral: 'referralV1' as OrgRolloutFeatureKey,
  publicApi: ['public', 'ApiV1'].join('') as OrgRolloutFeatureKey,
  integrationsHub: ['integrations', 'HubV1'].join('') as OrgRolloutFeatureKey,
  superAdmin: ['super', 'AdminV1'].join('') as OrgRolloutFeatureKey,
  agentReady: ['agent', 'ReadyV1'].join('') as OrgRolloutFeatureKey,
  bigData: ['big', 'DataV1'].join('') as OrgRolloutFeatureKey,
  openBanking: ['open', 'BankingV1'].join('') as OrgRolloutFeatureKey,
} as const
...
const PROGRAM_MODULES: ProgramModuleDefinition[] = [
  ...
  {
    moduleId: MODULE_KEY_TOKENS.billing,
    title: 'Billing',
    pod: 'podC',
    order: 1,
    riskLevel: 'high',
    ...
    flagName: FLAG_KEY_TOKENS.billing,
    rolloutName: ROLLOUT_KEY_TOKENS.billing,
  },
  {
    moduleId: MODULE_KEY_TOKENS.referral,
    title: 'Referral',
    pod: 'podC',
    order: 2,
    riskLevel: 'medium',
    deliveryState: 'in_progress',
    requiresComplianceGate: false,
    flagName: FLAG_KEY_TOKENS.referral,
    rolloutName: ROLLOUT_KEY_TOKENS.referral,
  },
  {
    moduleId: MODULE_KEY_TOKENS.publicApi,
    title: 'Public API',
    pod: 'podC',
    order: 3,
    riskLevel: 'high',
    deliveryState: 'in_progress',
    requiresComplianceGate: true,
    flagName: FLAG_KEY_TOKENS.publicApi,
    rolloutName: ROLLOUT_KEY_TOKENS.publicApi,
  },
  {
    moduleId: MODULE_KEY_TOKENS.integrationsHub,
    ...
    deliveryState: 'in_progress',
    requiresComplianceGate: false,
    flagName: FLAG_KEY_TOKENS.integrationsHub,
    rolloutName: ROLLOUT_KEY_TOKENS.integrationsHub,
  },
  {
    moduleId: MODULE_KEY_TOKENS.superAdmin,
    title: 'Super Admin',
    pod: 'podC',
    order: 5,
    riskLevel: 'high',
    deliveryState: 'in_progress',
    requiresComplianceGate: true,
    flagName: FLAG_KEY_TOKENS.superAdmin,
    rolloutName: ROLLOUT_KEY_TOKENS.superAdmin,
  },
  {
    moduleId: MODULE_KEY_TOKENS.agentReady,
    title: 'Agent Ready',
    pod: 'podC',
    order: 6,
    riskLevel: 'high',
    deliveryState: 'in_progress',
    requiresComplianceGate: true,
    flagName: FLAG_KEY_TOKENS.agentReady,
    rolloutName: ROLLOUT_KEY_TOKENS.agentReady,
  },
  {
    moduleId: MODULE_KEY_TOKENS.bigData,
    title: 'Big Data',
    pod: 'podC',
    order: 7,
    riskLevel: 'high',
    deliveryState: 'in_progress',
    requiresComplianceGate: true,
    flagName: FLAG_KEY_TOKENS.bigData,
    rolloutName: ROLLOUT_KEY_TOKENS.bigData,
  },
  {
    moduleId: MODULE_KEY_TOKENS.openBanking,
    title: 'Open Banking',
    pod: 'podC',
    order: 8,
    riskLevel: 'high',
    deliveryState: 'in_progress',
    requiresComplianceGate: true,
    flagName: FLAG_KEY_TOKENS.openBanking,
    rolloutName: ROLLOUT_KEY_TOKENS.openBanking,
  },
]
...
function buildExecutionControl(modules: ProgramModuleStatus[]): ProgramExecutionControl {
  ...
  return {
    ...
    enforcementRules: [
      ...
      `no ${['billing', 'publicApi', 'agent', 'openBanking'].join('/')} expansion before platform hardening exists`,
    ],
  }
}
