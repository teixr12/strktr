...
import { isPortalAdminV2Enabled } from '@/lib/portal-admin-v2/feature'
import { isPortalAdminV2EnabledForOrg } from '@/server/feature-flags/wave2-canary'

export function requirePortalAdminV2Enabled(request: Request): Response | null {
  if (isPortalAdminV2Enabled()) return null
  return fail(
    request,
    {
